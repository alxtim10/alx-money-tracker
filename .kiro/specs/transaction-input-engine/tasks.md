...
- [ ] 1. Establish domain models, enums, and pure logic scaffolding
  - [ ] 1.1 Define domain models and `TransactionType` enum
  ...
  - [ ] 1.2 Implement `AmountReducer` pure helper
  ...
  - [ ]* 1.3 Write property tests for `AmountReducer`
  ...
  - [ ]* 1.4 Write unit tests for `AmountReducer` edge cases
    - Explicit `deleteDigit(0) == 0`; append/preset clamp at `MAX_AMOUNT`
    - _Requirements: 1.4, 2.2_

- [ ] 2. Implement Room data layer (entities + database)
  - [ ] 2.1 Define Room entities
  ...
  - [ ] 2.2 Implement DAOs and the atomic `@Transaction` method
  ...
  - [ ] 2.3 Create Room `AppDatabase` and mappers
    - Register entities/DAOs; add entity↔domain mapping functions
    - _Requirements: 12.1_

  - [ ]* 2.4 Write Room in-memory integration tests for atomicity and Flow
...
- [ ] 4. Implement the repository
  - [ ] 4.1 Implement `TransactionRepository` interface and Room-backed implementation
  ...
  - [ ]* 4.2 Write property tests for balance-delta logic (Room in-memory / fake DAO)
  ...
  - [ ]* 4.3 Write unit test for repository error mapping
    - A thrown DAO exception is mapped to `Result.failure` (no raw exception escapes)
    - _Requirements: 9.5_

- [ ] 5. Implement UI state, validation, and selection logic
  - [ ] 5.1 Define `TransactionInputUiState` and `TransactionInputEvent`
  ...
  - [ ] 5.2 Implement `SubmitValidator` and selection/filter helpers
  ...
  - [ ]* 5.3 Write property test for submit gating
  ...
  - [ ]* 5.4 Write property tests for category/wallet/selection logic
...
- [ ] 6. Implement the ViewModel
  - [ ] 6.1 Implement `TransactionInputViewModel`
  ...
  - [ ] 6.2 Implement submit orchestration and post-save reset
  ...
  - [ ]* 6.3 Write property tests for transaction construction and reset
  ...
  - [ ]* 6.4 Write unit tests for ViewModel state defaults
...
- [ ] 8. Implement Compose UI (stateless, one-handed layout)
  - [ ] 8.1 Implement child composables
...
- [ ] 9. Wire the feature together
  - [ ] 9.1 Assemble screen, ViewModel, repository, and database
  ...
  - [ ]* 9.2 Write integration test for the end-to-end save path
